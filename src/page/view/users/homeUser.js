  ...
  return (
    <div className="bg-gradient-to-t from-[#ffffff] to-transparent min-h-screen">
      ...
      <div className="flex py-3 h-screen w-full shadow-lg rounded-lg">
        <MapContainer
          ref={mapRef}
          center={[-5.40573993508425, 105.25918454673199]}
          zoom={15}
              ...
              <Popup>
                <div>
                  ...
                  <span className="flex justify-center mt-1">
                    Tipe Perangkat: {list.type_device}
                  </span>

                  <div className="flex justify-center mt-2">
                    <button className="py-2 px-3 bg-red-600 hover:bg-red-300 active:bg-red-600 rounded-lg text-white shadow-lg" onClick={() => useGuid(list)}>
                      Minta Bantuan!
                    </button>
                  </div>
