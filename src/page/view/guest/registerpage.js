...
export default class RegisterPage extends Component {
  ...
  return (
    ...
    <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
      <aside
        className="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-7"
      >
        <img
          alt="Pattern"
          src={PhotoRegister}
        ...
        />
          ...
          <main
            aria-label="Main"
            className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:py-12 lg:px-16 xl:col-span-5"
          >
            <div className="max-w-xl lg:max-w-3xl py-8 px-14 rounded-3xl shadow-xl">
              <a className="block text-[#FEAE1C]" href="/">
              ...
              <h1
                className="mt-6 text-2xl font-bold text-gray-900 sm:text-xl md:text-3xl"
              >
                Selamat Datang di Warning System & Panic Button!
              </h1>
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-6 -mt-2">
                  <label htmlFor="Email" className="block text-sm font-normal text-gray-700">
                    ...
                    <Link to="/login">
                      <span className="text-[#FEAE1C] ml-1 font-semibold underline">Login</span>
                    </Link>
                  </label>
                </div>
